...
var NETWORK_NAME = "mychannel";
var CONTRACT_NAMESPACE = "org.example.animaltracking";
var CONTRACT_NAME = "animaltracking-ts";
var MSP_NAME = "Org1MSP";
var IDENTITY_LABEL = "admin";
...
var QueryClient = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        console.log('............');
                        console.log(' ');
                        console.log('Calling queryHist to get the history of Animal with demo registered species:' + species + ' and id:' + id);
                        console.log('===============================================================================================');
                        console.log(' ');
                        return [4 /*yield*/, animalTracking.queryHist(species, id)];
                    case 2:
                    ...
                    case 3:
                        ...
                        console.log('===========================================================================');
                        console.log(' ');
                        return [4 /*yield*/, animalTracking.queryByOwner(owner)];
                    case 4:
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, animalTracking.queryAdHoc(selector)];
                    case 6:
                    ...
                    case 7:
                        ...
                        console.log('=======================================================================');
                        console.log(' ');
                        return [4 /*yield*/, animalTracking.querySGRegistrations()];
                    case 8:
                        queryResponse4 = _a.sent();
                        return [4 /*yield*/, fs.writeFileSync('registrations.json', queryResponse4, 'utf8')];
                    case 9:
                        file4 = _a.sent();
                        console.log('the querySGRegistrations response is ' + queryResponse4);
                        console.log('Transaction complete.');
                        console.log(' ');
                        console.log('............');
                        gw.disconnect();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, readFileAsync(CCP_FILE)];
                    case 3:
                    ...
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, gateway.getNetwork(NETWORK_NAME)];
                    case 5:
                        network = _a.sent();
    ...
    QueryClient.prototype.checkWallet = function (wallet) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, wallet.exists(IDENTITY_LABEL)];
                    case 1:
