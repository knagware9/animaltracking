...
var NETWORK_NAME = "channel1";
var CONTRACT_NAMESPACE = "org.example.animaltracking";
var CONTRACT_NAME = "animaltracking-ts";
var EVENT_NAME = "animaltracking-ev";
var LISTENER_NAME = "animaltracking-ls";
var MSP_NAME = "org1msp";
var contract = null;
var IDENTITY_LABEL = "ibpuser";
...
var WALLET_DIRECTORY = path.join(currentDir, ".fabric-vscode/wallets/", "ibpuser");
var CCP_FILE = path.join(currentDir, "/", "connection_IBP.json");
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, contract.addContractListener(LISTENER_NAME, EVENT_NAME, function (error, event, blockNumber, transactionId, status) {
                                if (error) {
                                    console.error(error);
                                    return;
                                }
