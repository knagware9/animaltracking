...
class MyContract extends fabric_contract_api_1.Contract {
     ...
     */
    async register(ctx, animalDetails) {
        let animal;
        if (utils_1.Utils.checkJSON(animalDetails)) {
            ...
            const [species, id, dob, description, owner, location, field, status, productionType, isVaccinated] = animalDetails.toString().split(' ');
